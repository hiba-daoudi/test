...
public class Livre extends Document{
	...
	public Livre(String titre, String[] auteur,int année, String editeur, String genre, int Nbr_pages,String Tome, String isbn) {
		super(titre, auteur, année, editeur, genre,isbn);
		//this.Isbn=isbn;
